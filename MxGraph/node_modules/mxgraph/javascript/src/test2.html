<html>
    ...
    <script type="text/javascript">
      ...
      <script type="text/javascript">
        function main(container)
		{
			...
			else
			{
				...
				graph.setBackgroundImage(new mxImage('./images/cat.jpg', 360, 200));
				...
				try
				{
					...
					var v1 = graph.insertVertex(parent, null, 'FIrst LIne', 230, 10, 100, 100, 'image');
        ...
        function configureStylesheet(graph)
		{
			...
			style[mxConstants.STYLE_IMAGE] = 'images/dog.jpg';
			...
			style[mxConstants.STYLE_IMAGE] = 'images/tiger.jpg';
			...
			style[mxConstants.STYLE_IMAGE] = 'images/lion.jpg';
			...
			style[mxConstants.STYLE_IMAGE] = 'images/zebra.jpg';
      ...
      <body onload="main(document.getElementById('graphContainer'))">
            ...
            <div id="graphContainer" style="position:relative;overflow:auto;width:360px;height:200px;cursor:default;">
            </div>
      </body>
</html>